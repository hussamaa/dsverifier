function verify_limit_cycle(system, realization, xsize, varargin)
%
% Checks limit cycle property violation for digital systems using a bounded model checking tool.
% Function: VERIFY_LIMIT_CYCLE(system, realization, xsize)
%
% Where
...
%
% VERIFY_LIMIT_CYCLE(system, realization, xsize, bmc, solver, ovmode, rmode, emode, timeout)
%
% Where
...
%  ds.delta = ...;
%
%  VERIFY_LIMIT_CYCLE(ds,'DFI',10,'CBMC');
