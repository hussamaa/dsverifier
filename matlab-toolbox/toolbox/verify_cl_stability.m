function verify_cl_stability(system, realization, xsize, c_mode, varargin)
%
...
%
% VERIFY_CL_STABILITY(system, realization, xsize, bmc, solver, ovmode, rmode, emode, timeout)
%
% Where
...
%  ds.delta = ...;
%
%  VERIFY_CL_STABILITY(ds,'DFI',10,'CBMC');
%  VERIFICATION FAILED!
%
