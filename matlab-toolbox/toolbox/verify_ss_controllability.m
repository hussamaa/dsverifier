function verify_ss_controllability(system, realization, xsize, varargin)
%
...
% Function: VERIFY_SS_CONTROLLABILITY(system, realization, xsize)
%
% Where
...
%
% VERIFY_SS_CONTROLLABILITY(system, realization, xsize, bmc, solver, ovmode, rmode, emode, timeout)
%
% Where
...
%  ds.impl.frac_bits = ...;
%
%  VERIFY_SS_CONTROLLABILITY(ds,'DFI',10,'CBMC');
