...
int verify_error(void)
{
	...
	yf[i] = double_direct_form_1(yfaux, xfaux, da, db, ds.a_size,
		ds.b_size);
	...
	/* double precision implementation */
	yf[i] = double_direct_form_2(wfaux, xf[i], da, db, ds.a_size,
		ds.b_size);
#endif
	...
	/* double precision implementation */
	yf[i] = double_transposed_direct_form_2(wfaux, xf[i], ds.a, ds.b,
		ds.a_size, ds.b_size);
#endif
