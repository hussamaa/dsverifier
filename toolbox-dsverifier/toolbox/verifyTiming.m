function verify_timing(system, realization, xsize, varargin)
%
% Checks timing property violation for digital systems using a bounded model checking tool.
% Function: VERIFY_TIMING(system, realization, xsize)
%
% Where
...
%
% VERIFY_TIMING(system, realization, xsize, bmc, solver, ovmode, rmode, emode, timeout)
%
% Where
