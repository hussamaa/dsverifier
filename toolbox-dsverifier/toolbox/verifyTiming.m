function verifyTiming(system, intBits, fracBits, rangeMax, rangeMin, realization, kbound, varargin)
%
% Checks timing property violation for digital systems using a bounded model checking tool.
% Function: verifyTiming(system, intBits, fracBits, rangeMax, rangeMin, realization, kbound)
%
% Where
...
%
% verifyTiming(system, intBits, fracBits, rangeMax, rangeMin, realization, kbound, delta)
%
% Where
...
%
% verifyTiming(system, intBits, fracBits, rangeMax, rangeMin, realization, kbound, bmc, solver, ovmode, rmode, emode, timeout)
%
% For delta realization:
%
% verifyTiming(system, intBits, fracBits, rangeMax, rangeMin, realization, kbound, delta, bmc, solver, ovmode, rmode, emode, timeout)
%
% Where
...
%  system = tf(den,num,1);
%
%  verifyTiming(system,2,10,1,-1,'DFI',0.25);
%  VERIFICATION FAILED!
%
