function verify_ss_limit_cycle(system, realization, xsize, varargin)
%
% Checks limit cycle property violation for digital systems (state-space representation) using a bounded model checking tool.
% Function: VERIFY_SS_LIMIT_CYCLE(system, realization, xsize)
%
% Where
...
%
% VERIFY_SS_LIMIT_CYCLE(system, realization, xsize, bmc, solver, ovmode, rmode, emode, timeout)
%
% Where
...
%  ds.impl.frac_bits = ...;
%
%  VERIFY_SS_LIMIT_CYCLE(ds,'DFI',10,'CBMC');
