...
int main(){
   ...
   double b_ans[100];
   int b_ans_size = controller.b_size + plant.b_size - 1;
   double a_ans[100];
   int a_ans_size = controller.a_size + plant.a_size - 1;

   ft_closedloop_series(c_num_qtz, controller.b_size, c_den_qtz, controller.a_size, p_num, p_num_size, p_den, p_den_size, b_ans, b_ans_size, a_ans, a_ans_size);
   ...
   assert(b_ans[0] == 0.019989013671875);
   assert(b_ans[1] == -0.04998779296875);
   assert(b_ans[2] == 0.013214111328125);
   assert(b_ans[3] == 0.01519775390625);
   assert(b_ans[4] == -0.003173828125);
