...
int main(){
   ...
   fxp_double_to_fxp_array(controller.b, c_num_fxp, controller.b_size);
   fxp_t c_den_fxp[controller.a_size];
   fxp_double_to_fxp_array(controller.a, c_den_fxp, controller.a_size);
   ...
   double b_ans[100];
   int b_ans_size = controller.a_size + plant.b_size - 1;
   double a_ans[100];
   int a_ans_size = controller.a_size + plant.a_size - 1;

   ft_closedloop_feedback(c_num_qtz, controller.b_size, c_den_qtz, controller.a_size, p_num, p_num_size, p_den, p_den_size, b_ans, b_ans_size, a_ans, a_ans_size);
