...
digital_system(3).plant=tf([-0.01285, 0.02582, -0.01293],[1.0, -2.99, 2.983, -0.9929],0.01); %doyleetal
digital_system(4).plant=tf([15.1315, 17.8600, 17.4549],[1.0, -2.6207, 2.3586, -0.6570],2); %helicopter 
digital_system(5).plant=tf([0.2039, 0.2039],[1.0, 1.19999, 1.0 ],2); %pendulum 
digital_system(6).plant=tf([1.250000e-1, 1.250000e-1],[1.000000, -2.000000, 1.000000],0.001); %satelliteB2 
digital_system(7).plant=tf([5.000000e-5, 5.000000e-5],[1.000000, -2.000000, 1.000000],0.001); %spgMsDamper 
digital_system(8).plant=tf([0.25, 0.5, 0.25, -4.3341E-7],[1.0, 5.9150E-6, 1.0480E-11, -4.9349E-63, 7.0168E-225],2); %suspension 
digital_system(9).plant=tf([0.0200, -3.8303E-176],[1.0, -4.6764E-166], 2); %tapedriver 
...
digital_system(3).controller=tf([-0.580535888671875, 0.919769287109375, 0.11871337890625, -0.951934814453125],[0.7188720703125, -0.38751220703125, -0.415924072265625, 0.437286376953125],0.01); %doyleetal
digital_system(4).controller=tf([-0.0009765625, 0, 0],[ 0.76171875, 0, 0, 0 ],2); %helicopter

digital_system(5).controller=tf([-0.96484375, 0.9833984375],[0.8896484375, -0.875, 0 ],2); %pendulum 
digital_system(6).controller=tf([0.8359375, 0.265625, -0.96875],[0.9453125, 0.90625, -0.15625, -0.123046875],0.001); %satelliteB2 
digital_system(7).controller=tf([-0.0000000004656612873077392578125, 1.0000000004656612873077392578125, -1.0000000004656612873077392578125 ],[1, -0.0000000004656612873077392578125, 0.0000000004656612873077392578125],0.001); %spgMsDamper 
digital_system(8).controller=tf([-0.0224609375, 0, 0, 0 ],[0.138671875, 0, 0, 0, 0],2); %suspension 
digital_system(9).controller=tf([ 0, 0.0625 ],[0.517578125, -0.4990234375], 2); %tapedriver 
...
digital_system(3).int_bits38; digital_system(3).frac_bits= 8 ;
...
digital_system(8).int_bits=3; digital_system(8).frac_bits= 7 ;
