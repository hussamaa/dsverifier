...
#include <fxp.h>
	...
	double iirOutDouble(double y[], double x[], double a[], double b[], int Na, int Nb) {
	...
	double iirIIOutDouble(double w[], double x, double a[], double b[], int Na, int Nb) {
	...
	double iirIItOutDouble(double w[], double x, double a[], double b[], int Na, int Nb) {
		double *a_ptr, *b_ptr;
		double yout = 0;
		a_ptr = &a[1];
		b_ptr = &b[0];
