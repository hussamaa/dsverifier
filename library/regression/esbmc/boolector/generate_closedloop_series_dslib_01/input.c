...
int main(){
   ...
   double b_ans[100];
   int b_ans_size = control.b_size + plant.b_size - 1;
   double a_ans[100];
   int a_ans_size = control.a_size + plant.a_size - 1;

   ft_closedloop_series(c_num_qtz, control.b_size, c_den_qtz, control.a_size, p_num, p_num_size, p_den, p_den_size, b_ans, b_ans_size, a_ans, a_ans_size);
